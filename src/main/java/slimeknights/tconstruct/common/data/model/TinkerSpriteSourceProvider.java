  ...
  protected void addSources() {
    ...
    atlas(BLOCKS_ATLAS)
      ...
      .addSource(new PalettedPermutations(
        List.of(new ResourceLocation(trimItem + "helmet_trim"), new ResourceLocation(trimItem + "chestplate_trim"), new ResourceLocation(trimItem + "leggings_trim"), new ResourceLocation(trimItem + "boots_trim")),
